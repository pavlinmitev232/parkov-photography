  ...
  bg: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          "Supabase — база данни и съхранение в европейски регион",
          "Netlify — хостинг, доставка и защита на уебсайта",
          "Resend или конфигурираният имейл доставчик — известие до собственика за ново запитване",
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          "Supabase — database and storage in a European region",
          "Netlify — website hosting, delivery, and security",
          "Resend or the configured email provider — notification to the owner about a new inquiry",
